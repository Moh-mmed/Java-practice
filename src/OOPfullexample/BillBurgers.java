...
public class BillBurgers {
    ...
    public static void main(String[] args){
        ...
        baseBurger.setLettuce();
        baseBurger.setTomato();

        //Healthy Burger
        HealthyBurger healthyBurger = new HealthyBurger();
        healthyBurger.setCheese();
        healthyBurger.setHotPepper();
        healthyBurger.setCarrot();
        healthyBurger.setPepper();
        ...
        healthyBurger.getBill();


        // Deluxe burger
        System.out.println(deluxeBurger.getName());
        deluxeBurger.getBill();
